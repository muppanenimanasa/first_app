...
class PersonalsControllerTest < ActionController::TestCase
  ...
  test "should create personal" do
    assert_difference('Personal.count') do
      post :create, personal: { address: @personal.address, email: @personal.email, name: @personal.name, pnumber: @personal.pnumber }
    end
  ...
  test "should update personal" do
    put :update, id: @personal, personal: { address: @personal.address, email: @personal.email, name: @personal.name, pnumber: @personal.pnumber }
    assert_redirected_to personal_path(assigns(:personal))
  end
